...
import com.forexnews.app.domain.repository.SettingsRepository
...
class EventRepositoryImpl @Inject constructor(
    ...
    override fun getTodayHighImpactEvents(): Flow<List<EconomicEvent>> {
        ...
        return combine(
            ...
            events
                ...
                .map { entity ->
                    mapper.entityToDomain(entity, settings.timeZone, favoriteIds.contains(entity.id))
                }
        }
    }
    ...
    override fun getEventById(id: String): Flow<EconomicEvent?> {
        return combine(
            ...
            entity?.let { mapper.entityToDomain(it, settings.timeZone, isFav) }
        }
    }
    ...
    override fun getEventHistory(eventTitle: String, currency: String): Flow<List<EconomicEvent>> {
        return combine(
            ...
            entities.map { mapper.entityToDomain(it, settings.timeZone) }
        }
    }
